...
its variants, [StaSh](https://github.com/SnowleopardXI/pythonista-stash) is a serious attempt to
...
```Python
import requests as r; exec(r.get('https://raw.githubusercontent.com/SnowleopardXI/pythonista-stash/master/getstash.py').content)
```
